        ...
        <Grid divided columns='three'>
          <Grid.Row>
            <Grid.Column textAlign='center' style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
              ...
              <div className="icon-skills">
                <img className="logo-img" alt='logo-adobe' src={adobe} style={{ width: '2.4em' }} />
                <p className="text-skills">adobe XD</p>
              </div>
              <div className="icon-skills">
                <img className="logo-img" alt='responsive-logo' src={responsive} style={{ width: '2.4em' }} />
            ...
            <Grid.Column style={{}}>
              ...
              <ul>
                <li style={{ fontWeight: 'bold' }}>Librairies React.js utilisées :</li>
